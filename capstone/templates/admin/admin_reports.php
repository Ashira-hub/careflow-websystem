  ...
  <div>
    ...
    <div class="ad-shell">
      ...
      <div class="ad-card" style="margin-bottom:16px;">
        ...
        $chartCum = [];
        $running = 0;
        foreach ($dailyNewUsers as $day => $cnt) {
        ...
        <div class="ad-bars" style="height:260px;">
          <canvas id="adminDailyNewUsersChart" aria-label="Daily new accounts chart" role="img"></canvas>
        </div>
        <script>
          (function() {
            var el = document.getElementById('adminDailyNewUsersChart');

  ...
  <div>
    ...
    <section class="card" style="margin-bottom:16px;">
      <div class="stat-cards">
        <div class="card">
          <h4>Laboratory</h4>
          <div class="muted-small">Total Tests</div>
          <div class="stat-value" id="dbLab"><?php echo (int)$totalTests; ?></div>
        </div>
        <div class="card">
          <h4>Lab Records</h4>
          <div class="muted-small">Tests This Month</div>
          <div class="stat-value" id="dbRecords"><?php echo (int)$testsThisMonth; ?></div>
        </div>
        <div class="card">
          <h4>Reports</h4>
          <div class="muted-small">Patients This Month</div>
          <div class="stat-value" id="dbReports"><?php echo (int)$patientsThisMonth; ?></div>
        </div>
        <div class="card">
          <h4>Notification</h4>
          <div class="muted-small">Pending Tests</div>
          <div class="stat-value" id="dbProfile"><?php echo (int)$pendingTests; ?></div>
        </div>
      </div>
    </section>

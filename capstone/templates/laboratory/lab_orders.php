...
<div class="layout-sidebar full-bleed" style="padding: 24px 20px;">
  ...
  <div>
    ...
    <?php if (!empty($_SESSION['flash_error'])): ?>
      <div class="alert alert-error" style="margin:12px 0;">&nbsp;<?php echo nl2br(htmlspecialchars($_SESSION['flash_error']));
                                                                  unset($_SESSION['flash_error']); ?></div>
    <?php endif; ?>
    <?php if (!empty($_SESSION['flash_success'])): ?>
      <div class="alert" style="margin:12px 0;border-color:#bbf7d0;background:#ecfdf5;color:#065f46;">&nbsp;<?php echo nl2br(htmlspecialchars($_SESSION['flash_success']));
    ...
    <section class="card">
      ...
      <table>
        ...
        <tbody>
          <?php if (!$tests): ?>
            <tr id="emptyRow">
              <td colspan="7" class="muted" style="text-align:center;">No laboratory tests yet.</td>
            </tr>
          <?php else: ?>

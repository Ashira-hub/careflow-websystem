<?php $page='Laboratory Notifications'; include __DIR__.'/../../includes/header.php'; ?>
    ...
    <div class="sidepanel">
      <nav>
        <ul class="nav-list">
          ...
          <li><a href="/capstone/templates/laboratory/lab_results.php"><img src="/capstone/assets/img/medical-file.png" alt="Results" style="width:18px;height:18px;object-fit:contain;"> Lab Records</a></li>
...
(function(){
  ...
  async function load(){
    try{
      var res = await fetch('/capstone/notifications/pharmacy.php?role=laboratory', { cache: 'no-store' });
  ...
  if(btnClearAll){
    btnClearAll.addEventListener('click', async function(){
      try{
        var res = await fetch('/capstone/notifications/pharmacy.php?role=laboratory', { method:'DELETE' });

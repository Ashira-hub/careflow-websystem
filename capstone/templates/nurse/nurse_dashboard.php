...
try {
  ...
  $cntSchedule = $cntSchedule ?? 0;
  $cntRequest = $cntRequest ?? 0;
}
try {
    ...
    <section id="home" class="dashboard-hero" style="padding-top:10px;">
      ...
      <div class="stat-cards">
        <div class="card">
          ...
          <div class="stat-value" id="nrSch"><?php echo (int)$cntSchedule; ?></div>
        </div>
        <div class="card">
          <h4>Prescriptions</h4>
          <div class="muted-small">Total</div>
          <div class="stat-value" id="nrRx"><?php echo (int)$cntRx; ?></div>
        </div>
        <div class="card">
          <h4>Requests</h4>
          <div class="muted-small">Pending</div>
          <div class="stat-value" id="nrReq"><?php echo (int)$cntRequest; ?></div>
        </div>
        <div class="card">
          <h4>Reports</h4>
          <div class="muted-small">Completed</div>
          <div class="stat-value" id="nrRep"><?php echo (int)$cntReports; ?></div>
        </div>
      </div>

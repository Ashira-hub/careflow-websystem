  ...
  <div class="content" style="width:100%;max-width:none;margin:0;">
    ...
    <div class="ad-page">
      ...
      <div class="ad-chart">
        ...
        <div class="ad-bars" aria-label="Daily dispensed prescriptions bar chart">
          <?php foreach ($dailyDispensed as $day => $cnt): $h = max(6, (int)round(((int)$cnt / $maxDaily) * 100)); ?>
            <div class="ad-bar" title="<?php echo pr_escape($day); ?>: <?php echo (int)$cnt; ?>" style="height:<?php echo (int)$h; ?>%;"></div>
          <?php endforeach; ?>
        </div>
      </div>
    </div>

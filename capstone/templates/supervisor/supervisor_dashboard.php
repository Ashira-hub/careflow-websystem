...
usort($roster, function ($a, $b) {
  return strcmp(sd_norm($a['name']), sd_norm($b['name']));
});
  ...
  <div>
    <section id="home" class="dashboard-hero doctor-dashboard-hero">
      ...
      <div class="stat-cards">
        <div class="card">
          <h4>Schedules</h4>
          <div class="muted-small">Manage Schedules</div>
          <div class="stat-value"><?php echo sd_escape($staffOnDuty); ?></div>
        </div>
        <div class="card">
          <h4>Reports</h4>
          <div class="muted-small">Reports Details</div>
          <div class="stat-value"><?php echo sd_escape($openTasks); ?></div>
        </div>
        <div class="card">
          <h4>Notifications</h4>
          <div class="muted-small">View Notifications</div>
          <div class="stat-value"><?php echo sd_escape($incidentCount); ?></div>
        </div>
        <div class="card">
          <h4>Staff</h4>
          <div class="muted-small">Nurse List</div>
          <div class="stat-value"><?php echo sd_escape($escalations); ?></div>
        </div>
      </div>
  ...
  (function() {
    ...
    async function load() {
      try {
        ...
        var dataNot = resNot.ok ? await resNot.json() : {
          items: []
        };

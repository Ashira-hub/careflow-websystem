  ...
  <div class="content" style="width:100%;max-width:none;margin:0;">
    ...
    <div class="ad-page">
      ...
      <div class="ad-chart">
        ...
        <div class="ad-bars" aria-label="Daily accepted shifts bar chart">
          <?php foreach ($dailyAcceptedSeries as $day => $cnt): $h = max(6, (int)round(((int)$cnt / $maxDaily) * 100)); ?>
            <div class="ad-bar" title="<?php echo sr_escape($day); ?>: <?php echo (int)$cnt; ?>" style="height:<?php echo (int)$h; ?>%;"></div>
          <?php endforeach; ?>
        </div>
      </div>
    </div>
